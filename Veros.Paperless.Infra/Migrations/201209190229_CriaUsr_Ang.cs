namespace Veros.Paperless.Infra.Migrations
{
    ...
    [Migration(201209190229)]
    public class CriaUsrAng : Migration
    {
        public override void Up()
        {
            ...
            this.Database.CreateSequence("SEQ_USR_ANG");
        }

        public override void Down()
        {
            this.Database.RemoveTable("USR_ANG");
            this.Database.RemoveSequence("SEQ_USR_ANG");
        }
    }
}
