namespace Veros.Paperless.Infra.Migrations
{
    ...
    [Migration(201209190200)]
    public class CriaTdcampos : Migration
    {
        public override void Up()
        {
            this.Database.AddTable(
                ...
                new Column("TDCAMPOS_PAC", DbType.Int32),
                new Column("TDCAMPOS_DATATYPE", DbType.Int32),
                new Column("TDCAMPOS_VALIDACAO", DbType.AnsiString, 1),
                new Column("GRUPOCAMPO_CODE", DbType.Int32),
                new Column("GRUPOCAMPO_ORDEM", DbType.Int32),
                new Column("TDCAMPOS_REFARQUIVO", DbType.AnsiString, 1000));

            this.Database.CreateSequence("SEQ_TDCAMPOS");
        }

        public override void Down()
        {
            this.Database.RemoveTable("TDCAMPOS");
            this.Database.RemoveSequence("SEQ_TDCAMPOS");
        }
    }
}
