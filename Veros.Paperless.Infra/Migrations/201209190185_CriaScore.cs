namespace Veros.Paperless.Infra.Migrations
{
    ...
    [Migration(201209190185)]
    public class CriaScore : Migration
    {
        public override void Up()
        {
            ...
            this.Database.CreateSequence("SEQ_SCORE");
        }

        public override void Down()
        {
            this.Database.RemoveTable("SCORE");
            this.Database.RemoveSequence("SEQ_SCORE");
        }
    }
}
