namespace Veros.Paperless.Infra.Migrations
{
    ...
    [Migration(201209190230)]
    public class CriaUsrBk : Migration
    {
        public override void Up()
        {
            ...
            this.Database.CreateSequence("SEQ_USR_BK");
        }

        public override void Down()
        {
            this.Database.RemoveTable("USR_BK");
            this.Database.RemoveSequence("SEQ_USR_BK");
        }
    }
}
