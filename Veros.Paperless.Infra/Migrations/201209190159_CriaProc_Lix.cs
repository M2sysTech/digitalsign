namespace Veros.Paperless.Infra.Migrations
{
    ...
    [Migration(201209190159)]
    public class CriaProcLix : Migration
    {
        public override void Up()
        {
            ...
            this.Database.CreateSequence("SEQ_PROC_LIX");
        }

        public override void Down()
        {
            this.Database.RemoveTable("PROC_LIX");
            this.Database.RemoveSequence("SEQ_PROC_LIX");
        }
    }
}
