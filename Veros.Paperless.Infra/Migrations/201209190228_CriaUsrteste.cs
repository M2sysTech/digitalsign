namespace Veros.Paperless.Infra.Migrations
{
    ...
    [Migration(201209190228)]
    public class CriaUsrteste : Migration
    {
        public override void Up()
        {
            this.Database.AddTable(
                "USRTESTE",
                this.WithId("USRTESTE_CODE"),
            ...
            this.Database.CreateSequence("SEQ_USRTESTE");
        }

        public override void Down()
        {
            this.Database.RemoveTable("USRTESTE");
            this.Database.RemoveSequence("SEQ_USRTESTE");
        }
    }
}
