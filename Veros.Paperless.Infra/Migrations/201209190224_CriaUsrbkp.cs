namespace Veros.Paperless.Infra.Migrations
{
    ...
    [Migration(201209190224)]
    public class CriaUsrbkp : Migration
    {
        public override void Up()
        {
            this.Database.AddTable(
                "USRBKP",
                this.WithId("USRBKP_CODE"),
            ...
            this.Database.CreateSequence("SEQ_USRBKP");
        }

        public override void Down()
        {
            this.Database.RemoveTable("USRBKP");
            this.Database.RemoveSequence("SEQ_USRBKP");
        }
    }
}
