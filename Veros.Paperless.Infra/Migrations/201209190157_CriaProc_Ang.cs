namespace Veros.Paperless.Infra.Migrations
{
    ...
    [Migration(201209190157)]
    public class CriaProcAng : Migration
    {
        public override void Up()
        {
            ...
            this.Database.CreateSequence("SEQ_PROC_ANG");
        }

        public override void Down()
        {
            this.Database.RemoveTable("PROC_ANG");
            this.Database.RemoveSequence("SEQ_PROC_ANG");
        }
    }
}
