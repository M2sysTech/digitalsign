namespace Veros.Paperless.Infra.Migrations
{
    ...
    [Migration(201209190100)]
    public class CriaLogmdoc : Migration
    {
        public override void Up()
        {
            ...
            this.Database.CreateSequence("SEQ_LOGMDOC");
        }

        public override void Down()
        {
            this.Database.RemoveTable("LOGMDOC");
            this.Database.RemoveSequence("SEQ_LOGMDOC");
        }
    }
}
