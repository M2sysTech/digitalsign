namespace Veros.Paperless.Infra.Migrations
{
    ...
    [Migration(201209190231)]
    public class CriaUsrRmo : Migration
    {
        public override void Up()
        {
            ...
            this.Database.CreateSequence("SEQ_USR_RMO");
        }

        public override void Down()
        {
            this.Database.RemoveTable("USR_RMO");
            this.Database.RemoveSequence("SEQ_USR_RMO");
        }
    }
}
