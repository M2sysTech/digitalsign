namespace Veros.Paperless.Infra.Migrations
{
    ...
    [Migration(201209190091)]
    public class CriaIpconfigPhe : Migration
    {
        public override void Up()
        {
            ...
            this.Database.CreateSequence("SEQ_IPCONFIG_PHE");
        }

        public override void Down()
        {
            this.Database.RemoveTable("IPCONFIG_PHE");
            this.Database.RemoveSequence("SEQ_IPCONFIG_PHE");
        }
    }
}
