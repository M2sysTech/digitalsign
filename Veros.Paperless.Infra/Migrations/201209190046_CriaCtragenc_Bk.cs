namespace Veros.Paperless.Infra.Migrations
{
    ...
    [Migration(201209190046)]
    public class CriaCtragencBk : Migration
    {
        public override void Up()
        {
            ...
            this.Database.CreateSequence("SEQ_CTRAGENC_BK");
        }

        public override void Down()
        {
            this.Database.RemoveTable("CTRAGENC_BK");
            this.Database.RemoveSequence("SEQ_CTRAGENC_BK");
        }
    }
}
