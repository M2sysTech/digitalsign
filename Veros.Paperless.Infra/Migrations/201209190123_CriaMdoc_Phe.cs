namespace Veros.Paperless.Infra.Migrations
{
    ...
    [Migration(201209190123)]
    public class CriaMdocPhe : Migration
    {
        public override void Up()
        {
            ...
            this.Database.CreateSequence("SEQ_MDOC_PHE");
        }

        public override void Down()
        {
            this.Database.RemoveTable("MDOC_PHE");
            this.Database.RemoveSequence("SEQ_MDOC_PHE");
        }
    }
}
