namespace Veros.Paperless.Infra.Migrations
{
    ...
    [Migration(201209190021)]
    public class CriaBatch : Migration
    {
        public override void Up()
        {
            ...
            this.Database.CreateSequence("SEQ_BATCH");
        }

        public override void Down()
        {
            this.Database.RemoveTable("BATCH");
            this.Database.RemoveSequence("SEQ_BATCH");
        }
    }
}
