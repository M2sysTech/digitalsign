namespace Veros.Paperless.Infra.Migrations
{
    ...
    [Migration(201209190223)]
    public class CriaUsr : Migration
    {
        public override void Up()
        {
            this.Database.AddTable(
                "USR",
                this.WithId("USR_CODE"),
                ...
                new Column("USR_PAUSA", DbType.AnsiString, 1),
                new Column("PERFIL_CODE", DbType.Int32));

            this.Database.CreateSequence("SEQ_USR");
        }

        public override void Down()
        {
            this.Database.RemoveTable("USR");
            this.Database.RemoveSequence("SEQ_USR");
        }
    }
}
