namespace Veros.Paperless.Infra.Migrations
{
    ...
    [Migration(201209190056)]
    public class CriaDocLix : Migration
    {
        public override void Up()
        {
            ...
            this.Database.CreateSequence("SEQ_DOC_LIX");
        }

        public override void Down()
        {
            this.Database.RemoveTable("DOC_LIX");
            this.Database.RemoveSequence("SEQ_DOC_LIX");
        }
    }
}
