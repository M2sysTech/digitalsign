namespace Veros.Paperless.Infra.Migrations
{
    ...
    [Migration(201209190045)]
    public class CriaCtragenc : Migration
    {
        public override void Up()
        {
            ...
            this.Database.CreateSequence("SEQ_CTRAGENC");
        }

        public override void Down()
        {
            this.Database.RemoveTable("CTRAGENC");
            this.Database.RemoveSequence("SEQ_CTRAGENC");
        }
    }
}
