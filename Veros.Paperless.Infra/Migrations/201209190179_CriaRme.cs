namespace Veros.Paperless.Infra.Migrations
{
    ...
    [Migration(201209190179)]
    public class CriaRme : Migration
    {
        public override void Up()
        {
            ...
            this.Database.CreateSequence("SEQ_RME");
        }

        public override void Down()
        {
            this.Database.RemoveTable("RME");
            this.Database.RemoveSequence("SEQ_RME");
        }
    }
}
