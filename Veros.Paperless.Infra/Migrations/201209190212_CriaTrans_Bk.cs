namespace Veros.Paperless.Infra.Migrations
{
    ...
    [Migration(201209190212)]
    public class CriaTransBk : Migration
    {
        public override void Up()
        {
            ...
            this.Database.CreateSequence("SEQ_TRANS_BK");
        }

        public override void Down()
        {
            this.Database.RemoveTable("TRANS_BK");
            this.Database.RemoveSequence("SEQ_TRANS_BK");
        }
    }
}
