namespace Veros.Paperless.Infra.Migrations
{
    ...
    [Migration(201209190133)]
    public class CriaPack : Migration
    {
        public override void Up()
        {
            ...
            this.Database.CreateSequence("SEQ_PACK");
        }

        public override void Down()
        {
            this.Database.RemoveTable("PACK");
            this.Database.RemoveSequence("SEQ_PACK");
        }
    }
}
