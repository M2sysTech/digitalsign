namespace Veros.Paperless.Infra.Migrations
{
    ...
    [Migration(201209190203)]
    public class CriaTdcamposBkpmaio2 : Migration
    {
        public override void Up()
        {
            ...
            this.Database.CreateSequence("SEQ_TDCAMPOS_BKPMAIO2");
        }

        public override void Down()
        {
            this.Database.RemoveTable("TDCAMPOS_BKPMAIO2");
            this.Database.RemoveSequence("SEQ_TDCAMPOS_BKPMAIO2");
        }
    }
}
